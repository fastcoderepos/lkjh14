...
import com.fastcode.lkjh14.domain.core.authorization.userpreference.IUserpreferenceManager;
...
public class UserControllerTest {
    ...
    public static void cleanup() {
        ...
        em.createNativeQuery("truncate table public.f_user RESTART IDENTITY").executeUpdate();
        em.createNativeQuery("truncate table public.userpreference RESTART IDENTITY").executeUpdate();
