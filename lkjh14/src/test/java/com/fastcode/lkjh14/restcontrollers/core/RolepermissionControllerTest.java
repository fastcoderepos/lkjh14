...
import com.fastcode.lkjh14.application.core.authorization.rolepermission.dto.*;
import com.fastcode.lkjh14.commons.logging.LoggingHelper;
import com.fastcode.lkjh14.domain.core.authorization.permission.IPermissionRepository;
import com.fastcode.lkjh14.domain.core.authorization.permission.PermissionEntity;
import com.fastcode.lkjh14.domain.core.authorization.role.IRoleRepository;
import com.fastcode.lkjh14.domain.core.authorization.role.RoleEntity;
import com.fastcode.lkjh14.domain.core.authorization.rolepermission.IRolepermissionRepository;
import com.fastcode.lkjh14.domain.core.authorization.rolepermission.RolepermissionEntity;
import com.fastcode.lkjh14.domain.core.authorization.rolepermission.RolepermissionId;
...
public class RolepermissionControllerTest {
    ...
    public static void cleanup() {
        ...
        em.createNativeQuery("truncate table public.rolepermission RESTART IDENTITY").executeUpdate();
        em.createNativeQuery("truncate table public.permission RESTART IDENTITY").executeUpdate();
        em.createNativeQuery("truncate table public.role RESTART IDENTITY").executeUpdate();
