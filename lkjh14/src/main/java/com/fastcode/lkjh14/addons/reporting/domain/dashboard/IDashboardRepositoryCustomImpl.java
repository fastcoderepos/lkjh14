package com.fastcode.lkjh14.addons.reporting.domain.dashboard;

import com.fastcode.lkjh14.addons.reporting.application.dashboard.dto.DashboardDetailsOutput;
import java.time.*;
