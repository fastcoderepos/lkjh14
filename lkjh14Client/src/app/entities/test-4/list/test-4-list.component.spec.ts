...
import { ITest4, Test4Service, Test4DetailsComponent, Test4ListComponent, Test4NewComponent } from '../';

describe('Test4ListComponent', () => {
  let fixture: ComponentFixture<Test4ListComponent>;
  let component: Test4ListComponent;
  let el: HTMLElement;

  let d = new Date();
  let t = DateUtils.formatDateStringToAMPM(d);
  let constData: ITest4[] = [
    {
      id: 1,
    },
    {
  ...
  let data: ITest4[] = [...constData];

  describe('Unit tests', () => {
    beforeEach(async(() => {
      TestBed.configureTestingModule({
        declarations: [Test4ListComponent, ListComponent],
        imports: [TestingModule],
        providers: [Test4Service, ChangeDetectorRef],
        schemas: [NO_ERRORS_SCHEMA],
      }).compileComponents();
    }));

    beforeEach(() => {
      fixture = TestBed.createComponent(Test4ListComponent);
  ...
  describe('Integration tests', () => {
      ...
      TestBed.configureTestingModule({
        ...
        imports: [
          ...
          RouterTestingModule.withRoutes([
            { path: 'test4', component: Test4ListComponent },
            { path: 'test4/:id', component: Test4DetailsComponent },
          ]),
        ],
        providers: [Test4Service, ChangeDetectorRef],
      }).compileComponents();
    ...
    it('should verify that redirected to details page when edit button is clicked', async () => {
      ...
      expect(decodeURIComponent(location.path())).toBe(
        `/test4/${ServiceUtils.encodeIdByObject(data[0], component.primaryKeys)}`
      );
    });
