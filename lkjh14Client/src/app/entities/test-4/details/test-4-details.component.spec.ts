...
import { ITest4, Test4Service, Test4DetailsComponent, Test4ListComponent } from '../';
...
describe('Test4DetailsComponent', () => {
  let component: Test4DetailsComponent;
  let fixture: ComponentFixture<Test4DetailsComponent>;
  let el: HTMLElement;
  ...
  describe('Unit Tests', () => {
    beforeEach(async(() => {
      TestBed.configureTestingModule({
        declarations: [Test4DetailsComponent, DetailsComponent],
    ...
    beforeEach(() => {
      fixture = TestBed.createComponent(Test4DetailsComponent);
  ...
  describe('Integration Tests', () => {
    beforeEach(async(() => {
      TestBed.configureTestingModule({
        declarations: [Test4DetailsComponent, Test4ListComponent, DetailsComponent, ListComponent, FieldsComp].concat(
          EntryComponents
        ),
        imports: [
          TestingModule,
          RouterTestingModule.withRoutes([
            { path: 'test4', component: Test4DetailsComponent },
            { path: 'test4/:id', component: Test4ListComponent },
          ]),
        ],
        providers: [Test4Service],
      }).compileComponents();
    ...
    it('should go back to list component when back button is clicked', async () => {
      ...
      expect(location.path()).toBe('/test4');
    });
  });
});
