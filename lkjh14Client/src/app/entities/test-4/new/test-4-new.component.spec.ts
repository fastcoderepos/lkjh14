...
import { ITest4, Test4Service, Test4NewComponent } from '../';
import { DateUtils } from 'src/app/common/shared';
import { NewComponent, FieldsComp } from 'src/app/common/general-components';

describe('Test4NewComponent', () => {
  let component: Test4NewComponent;
  let fixture: ComponentFixture<Test4NewComponent>;
  ...
  describe('Unit tests', () => {
    beforeEach(async(() => {
      TestBed.configureTestingModule({
        declarations: [Test4NewComponent, NewComponent, FieldsComp],
        imports: [TestingModule],
        providers: [Test4Service, { provide: MAT_DIALOG_DATA, useValue: {} }],
        schemas: [NO_ERRORS_SCHEMA],
      }).compileComponents();
    }));

    beforeEach(() => {
      fixture = TestBed.createComponent(Test4NewComponent);
  ...
  describe('Integration tests', () => {
    ...
    describe('', () => {
      it('should set the passed data to form', async () => {
        TestBed.configureTestingModule({
          declarations: [Test4NewComponent, NewComponent, FieldsComp].concat(EntryComponents),
          imports: [TestingModule],
          providers: [Test4Service, { provide: MAT_DIALOG_DATA, useValue: relationData }],
        });
