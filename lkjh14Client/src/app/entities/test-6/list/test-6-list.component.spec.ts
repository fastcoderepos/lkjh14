...
import { ITest6, Test6Service, Test6DetailsComponent, Test6ListComponent, Test6NewComponent } from '../';

describe('Test6ListComponent', () => {
  let fixture: ComponentFixture<Test6ListComponent>;
  let component: Test6ListComponent;
  let el: HTMLElement;

  let d = new Date();
  let t = DateUtils.formatDateStringToAMPM(d);
  let constData: ITest6[] = [
    {
      id: 1,
      version: 1,
    },
  ...
  let data: ITest6[] = [...constData];

  describe('Unit tests', () => {
    beforeEach(async(() => {
      TestBed.configureTestingModule({
        declarations: [Test6ListComponent, ListComponent],
        imports: [TestingModule],
        providers: [Test6Service, ChangeDetectorRef],
        schemas: [NO_ERRORS_SCHEMA],
      }).compileComponents();
    }));

    beforeEach(() => {
      fixture = TestBed.createComponent(Test6ListComponent);
  ...
  describe('Integration tests', () => {
      ...
      TestBed.configureTestingModule({
        ...
        imports: [
          ...
          RouterTestingModule.withRoutes([
            { path: 'test6', component: Test6ListComponent },
            { path: 'test6/:id', component: Test6DetailsComponent },
          ]),
        ],
        providers: [Test6Service, ChangeDetectorRef],
      }).compileComponents();
    ...
    it('should verify that redirected to details page when edit button is clicked', async () => {
      ...
      expect(decodeURIComponent(location.path())).toBe(
        `/test6/${ServiceUtils.encodeIdByObject(data[0], component.primaryKeys)}`
      );
    });
