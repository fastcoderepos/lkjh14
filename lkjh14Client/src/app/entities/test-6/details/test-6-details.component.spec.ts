...
import { ITest6, Test6Service, Test6DetailsComponent, Test6ListComponent } from '../';
...
describe('Test6DetailsComponent', () => {
  let component: Test6DetailsComponent;
  let fixture: ComponentFixture<Test6DetailsComponent>;
  let el: HTMLElement;
  ...
  describe('Unit Tests', () => {
    beforeEach(async(() => {
      TestBed.configureTestingModule({
        declarations: [Test6DetailsComponent, DetailsComponent],
    ...
    beforeEach(() => {
      fixture = TestBed.createComponent(Test6DetailsComponent);
  ...
  describe('Integration Tests', () => {
    beforeEach(async(() => {
      TestBed.configureTestingModule({
        declarations: [Test6DetailsComponent, Test6ListComponent, DetailsComponent, ListComponent, FieldsComp].concat(
          EntryComponents
        ),
        imports: [
          TestingModule,
          RouterTestingModule.withRoutes([
            { path: 'test6', component: Test6DetailsComponent },
            { path: 'test6/:id', component: Test6ListComponent },
          ]),
        ],
        providers: [Test6Service],
      }).compileComponents();
    ...
    it('should go back to list component when back button is clicked', async () => {
      ...
      expect(location.path()).toBe('/test6');
    });
  });
});
